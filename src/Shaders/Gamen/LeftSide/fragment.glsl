...
void main() {
    ...
    // Pattern 29 :  PETIT POINT
    // float strength = 0.015 / distance(vUv, vec2(0.5));

    // Pattern 30 : GROS POINT
    // vec2 lightUv = vec2(
    //   vUv.x * 0.1 + 0.45,
    //   vUv.y * 0.5 + 0.25
    // );
    ...
    // Pattern 35 : OVALE CREUX
    // float strength = step(0.01, abs(distance(vUv, vec2(0.5)) - 0.25));

    // Pattern 36 : OVALE INVERSE
    ...
    // Pattern 38 : DEFORMED WITH TACHES
    // vec2 wavedUv = vec2(
  ...
  // Pattern 49
  // float strength = sin(cnoise(vUv * 10.0) * 99.0);
